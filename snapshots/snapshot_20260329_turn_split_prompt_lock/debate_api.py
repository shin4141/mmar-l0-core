...
def _speaker_prompt(
    ...
    turn_mode_block = (
        ...
        "- Turn 2 and later are direct combat.\n"
        "- Rebuild your position, resolve inconsistencies, and push toward conclusion.\n"
        "- Do not open multiple new battlefields.\n"
    )
    context_block = (
        f"Topic: {cfg.topic}\n"
    ...
    startup_rule = (
        ...
        if turn_no == 2
        else "- Now reconcile and close if the opponent's structure is broken.\n"
    )
    transcript_block = (
        ""
        if turn_no == 1
