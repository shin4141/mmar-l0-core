    ...
    *,
    ...
    if turn_name == "turn1":
        spec = (
            ...
            "- Sentence 1: strike immediately. State the side and the pain point at the same time.\n"
            "- Sentence 2: push one strongest reason only.\n"
            "- Sentence 3: give one concrete example or observation only.\n"
            "- Prefer a line that feels publishable and sharp over a careful explanation.\n"
        )
    elif turn_name == "turn2":
        spec = (
            "Write one short Japanese rebuttal as a single paragraph of 2 to 3 sentences.\n"
            "- Attack one fatal flaw in the opponent's latest turn. Make it specific to what they just said.\n"
            "- Use one concrete metaphor that fits this topic; avoid generic metaphors.\n"
            "- End by driving your own thesis forward, not by merely restating it flatly.\n"
        )
    else:
        spec = (
            ...
            "- Keep pressure on your side's remaining reason.\n"
    ...
    return (
        ...
        + "- Keep it readable, sharp, and natural.\n"
    )
