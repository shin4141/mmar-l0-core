...
def _speaker_prompt(
    ...
    return (
        ...
        "- Turn 1: do not hedge, do not balance, and do not consider the opponent yet.\n"
        "- Turn 1 must state the position strongly and directly, then include one causal chain, one concrete example, and one short preemption.\n"
