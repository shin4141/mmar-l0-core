...
function renderSummary(summary) {
  ...
  detailPanelEl.innerHTML = `
    ...
    <details class="analysis-details" open>
      <summary>Prediction Check</summary>
      <div class="analysis-detail-copy">${escapeHtml(`Your pick: ${predictionCheck.user_pick || "none"} / Actual: ${predictionCheck.actual_winner || "?"} / ${predictionCheck.match ? "match" : "mismatch"}`)}</div>
    </details>` : ""}
    ${predictionFeedback ? `
    <details class="analysis-details" open>
      <summary>Prediction Feedback</summary>
      <div class="analysis-detail-copy">${escapeHtml(predictionFeedback)}</div>
    </details>` : ""}
    ${fairnessRewrite ? `
    <details class="analysis-details" open>
      <summary>Fairness Rewrite</summary>
