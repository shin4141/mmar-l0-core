...
DOMAIN_REGISTRY: dict[str, dict] = {
    ...
    "asset_allocation": {
        ...
        "next_question_candidates": ["運用期間は？（短期/中期/長期）", "レバレッジを許容しますか？（可/不可）"],
        "banned_axes": ["健康効果"],
    },
    "shopping": {
    ...
    "leisure": {
        "keywords": ["旅行", "遊び", "観光", "ホテル", "旅程", "休暇", "チケット", "横浜", "鎌倉", "リラックス", "散歩", "映画館", "レンタル", "家", "自宅"],
        "axes_candidates": ["没入", "気楽さ", "混雑耐性", "移動負荷", "予算"],
        "falsifier_templates": [
            "天候/混雑で体験価値が下がるなら反転",
            "移動遅延リスクが高い場合は代替案へ反転",
        ],
        "next_question_candidates": ["今日は没入（映画館）と気楽さ（家）のどちらを優先する？", "予算上限は？", "日程は？"],
        "banned_axes": ["健康効果", "体調（コンディション）", "お腹の調子"],
    },
    "travel_safety": {
